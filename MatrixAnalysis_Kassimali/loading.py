...
class R2_Point_Moment():
    ...
    def __init__(self, M, a, member, loadtype="D"):
        '''
...
class R2_Linear_Load():
    ...
    def integration_constants(self):
        ...
        self.c1 = (((((2*b*b)+((-a-3*L)*b)-(a*a)+(3*L*a))*w2)
                   +(((b*b)+((a-3*L)*b)-(2*a*a)+(3*L*a))*w1))
                    /(6*L))
        self.c2 = (((((2*b*b*b)+((-3*a-3*L)*b*b)+(6*L*a*b)+(a*a*a))*w2)
                   +(((b*b*b)-(3*L*b*b)-(3*a*a*b)+(2*a*a*a))*w1))
                    /(6*L*b-6*L*a))
        self.c3 = ((((2*b*b-a*b-a*a)*w2)
                   +((b*b+a*b-2*a*a)*w1))
                    /(6*L))
        self.c4 = 0
        self.c5 = -1*((a*a*a*w2)+((2*a*a*a-3*a*a*b)*w1))/(6*b-6*a)
        self.c6 = -1*((2*b*b-a*b-a*a)*w2+(b*b+a*b-2*a*a)*w1)/6
        self.c7 = (((12*b*b*b*b+(-3*a-45*L)*b*b*b+(-3*a*a+15*L*a+40*L*L)*b*b+(-3*a*a*a+15*L*a*a-20*L*L*a)*b-3*a*a*a*a+15*L*a*a*a-20*L*L*a*a)*w2
                   +(3*b*b*b*b+(3*a-15*L)*b*b*b+(3*a*a-15*L*a+20*L*L)*b*b+(3*a*a*a-15*L*a*a+20*L*L*a)*b-12*a*a*a*a+45*L*a*a*a-40*L*L*a*a)*w1)
                    /(360*L))
        self.c8 = (((12*b*b*b*b*b+(-15*a-45*L)*b*b*b*b+(60*L*a+40*L*L)*b*b*b-60*L*L*a*b*b+3*a*a*a*a*a+20*L*L*a*a*a)*w2
                   +(3*b*b*b*b*b-15*L*b*b*b*b+20*L*L*b*b*b+(-15*a*a*a*a-60*L*L*a*a)*b+12*a*a*a*a*a+40*L*L*a*a*a)*w1)
                    /(360*L*b-360*L*a))
        self.c9 = (((12*b*b*b*b-3*a*b*b*b+(40*L*L-3*a*a)*b*b+(-3*a*a*a-20*L*L*a)*b-3*a*a*a*a-20*L*L*a*a)*w2
                   +(3*b*b*b*b+3*a*b*b*b+(3*a*a+20*L*L)*b*b+(3*a*a*a+20*L*L*a)*b-12*a*a*a*a-40*L*L*a*a)*w1)
                    /(360*L))
        self.c10 = 0
        self.c11 = -1*(a*a*a*a*a*w2+(4*a*a*a*a*a-5*a*a*a*a*b)*w1)/(120*b-120*a)
        self.c12 = -1*((4*b*b*b*b-a*b*b*b-a*a*b*b-a*a*a*b-a*a*a*a)*w2+(b*b*b*b+a*b*b*b+a*a*b*b+a*a*a*b-4*a*a*a*a)*w1)/120
